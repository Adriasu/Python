...
numeros = [10, 20, 30, 40, 50]
# numeros[0], numeros[-1] = numeros[-1], numeros[0] --> en una sola línea
numeros[0] = 50
numeros[-1] = 10
print(numeros)
...
lista = [1, 2, 3, 4, 5, 6]
mitad = len(lista) // 2
lista_invertida_mitad = lista[:mitad][::-1] + lista[mitad:]
print(lista_invertida_mitad)